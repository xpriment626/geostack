...
Use DeepWiki (read_wiki_structure, read_wiki_contents, ask_question) to pull *implementation-level* detail from open-source codebases relevant to the anchorClaim — how it's actually built and shipped, not how docs describe it. Identify 1–3 repositories that substantiate (or complicate) the claim and extract concrete, code-grounded findings. Do not fabricate; cite the repo + path/ref.
